...
public final class BlankTicketPonderScenes {
    ...
    public static void usingBlankTickets(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(itemDisplay, Pointing.DOWN)
                .withItem(new ItemStack(ModItems.BLANK_TICKET.get())), 100);
        ...
        scene.addKeyframe();
        scene.overlay.showControls(new InputWindowElement(itemDisplay, Pointing.DOWN)
                .withItem(new ItemStack(ModItems.TICKET_BLUEPRINT.get())), 120);
        ...
        scene.addKeyframe();
        scene.overlay.showControls(new InputWindowElement(itemDisplay, Pointing.DOWN)
                .withItem(new ItemStack(ModItems.INCOMPLETE_TRANSIT_TICKET.get())), 100);
        scene.overlay.showText(100)
        ...
        scene.addKeyframe();
        scene.overlay.showControls(new InputWindowElement(itemDisplay, Pointing.DOWN)
                .withItem(new ItemStack(ModItems.TRANSIT_TICKET.get())), 120);
        scene.overlay.showText(120)
